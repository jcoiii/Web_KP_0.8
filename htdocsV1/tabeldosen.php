...
tr:nth-child(even) {
 ...
 <a class="navbar-brand" href="homeadmin.php">Beranda</a>		
   ...
   <br>
        <br>
 <h1 class="h3 mb-3 font-weight-normal">Daftar Dosen Pembimbing Kerja Praktek</h1>     
<br>
...
<?php		
 ...
 $con=mysqli_connect('localhost','root','') or die(mysqli_error());
    ...
    echo "<table><tr><th>Nama Dosen</th><th>Email</th><th>NIK</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["namadosen"]. "</td><td>" . $row["email"]. "</td><td>" . $row["username"]."</td></tr>";
    }
    echo "</table>";
} else {
...
<br>    
<div class="container">
  <a class="btn btn-primary" href="logbookmhs.php" role="button">Input Data Dosen</a>
</div>        
