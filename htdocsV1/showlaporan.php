...
tr:nth-child(even) {
 ...
 <a class="navbar-brand" href="homeadmin.php">Beranda</a>		
   ...
   <br>
        <br>
 <h1 class="h3 mb-3 font-weight-normal">Daftar Laporan Kerja Praktek</h1>     
<br>
...
<?php		
 ...
 $con=mysqli_connect('localhost','root','') or die(mysqli_error());
    ...
    echo "<table><tr><th>Kelompok</th><th>Nama File</th><th>Waktu Unggah</th></tr>";    
    if ($result->num_rows > 0) {
    
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["kelompok"]. "</td><td>" . $row["file_name"]."</td><td>" . $row["waktu_upload"]."</td></tr>";
    }
...
?>
 <br>      
<div class="container">
  <a class="btn btn-danger" href="\laporan" role="button">Folder Laporan</a>
</div>        
