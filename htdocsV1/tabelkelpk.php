...
tr:nth-child(even) {
 ...
 <a class="navbar-brand" href="homeadmin.php">Beranda</a>		
   ...
   <br>
        <br>
 <h1 class="h3 mb-3 font-weight-normal">Daftar Kelompok Kerja Praktek</h1>     
<br>
...
<?php		
 ...
 $con=mysqli_connect('localhost','root','') or die(mysqli_error());
      mysqli_select_db($con, 'kp') or die("cannot select DB"); 
        $sql = "SELECT * FROM kelompok_kp";
        $result = $con->query($sql);
        
    if ($result->num_rows > 0) {
    echo "<table><tr><th>NIK</th><th>Kelompok</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["username"]. "</td><td>" . $row["kelompok"]."</td></tr>";
    }
    echo "</table>";
} else {
...
<br>    
<div class="container">
  <a class="btn btn-primary" href="logbookmhs.php" role="button">Input Data Kelompok</a>
</div>        
