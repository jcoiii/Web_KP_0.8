...
<html lang="id">
  <head>
    ...
    <title>Laman Persetujuan Permohonan Admin</title>
    <!-- Bootstrap -->
...
<br>
 ...
 <?php   
        ...
        $query  =   "SELECT id, kelompok, perusahaan, tanggal, status FROM proposal";  
        ...
        if(isset($_POST['tombol'])){    
            ...
            $nrc        =   "UPDATE proposal SET status='Diterbitkan' WHERE id='".$ndatake."'";
